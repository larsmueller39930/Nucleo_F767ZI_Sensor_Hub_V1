...
static void SPIS_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SPIS_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        else if (SPIS_SCB_MODE_SPI == mode)
        {
        ...
        #if (SPIS_SCLK_PIN)
            hsiomSel[SPIS_SCLK_PIN_INDEX] = SPIS_SCLK_HSIOM_SEL_SPI;
        #endif /* (SPIS_SCLK_PIN) */
            ...
            if (SPIS_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[SPIS_SS0_PIN_INDEX] = SPIS_SS0_HSIOM_SEL_SPI;
        ...
        else /* UART */
        {
            ...
            else /* Standard or IrDA */
            {
                ...
                if (SPIS_UART_MODE_STD == subMode)
                {
                    ...
                    #if (SPIS_SCLK_PIN)
                        hsiomSel[SPIS_SCLK_PIN_INDEX] = SPIS_SCLK_HSIOM_SEL_UART;
                        pinsDm  [SPIS_SCLK_PIN_INDEX] = SPIS_PIN_DM_DIG_HIZ;
                    #endif /* (SPIS_SCLK_PIN) */
                    }
                    ...
                    #if (SPIS_SS0_PIN)
                        hsiomSel[SPIS_SS0_PIN_INDEX] = SPIS_SS0_HSIOM_SEL_UART;
                        pinsDm  [SPIS_SS0_PIN_INDEX] = SPIS_PIN_DM_STRONG;
