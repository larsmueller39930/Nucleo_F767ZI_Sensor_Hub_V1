// ======================================================================
// PSOC4_ForwardVoltageTSEP.v generated from TopDesign.cysch
// 09/23/2019 at 09:50
...
module ADC_SAR_SEQ_P4_v2_50_2 (
    ...
    defparam cy_psoc4_sarmux_8.input_mode = "10";
	...
	cy_clock_v1_0
		#(.id("0308ffab-87ad-49b0-a31e-391c4c7649e3/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    OpAmp_P4_v1_20_0 Opamp_1 (
        .Vplus(Net_422),
        .Vout(Net_465),
        .Vminus(Net_357));

    OpAmp_P4_v1_20_1 Opamp_2 (
        .Vplus(Net_423),
        .Vout(Net_430),
        .Vminus(Net_300));

    ADC_SAR_SEQ_P4_v2_50_2 ADC_SAR (
        .Vref(Net_196),
        .sdone(Net_197),
        .eoc(Net_198),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__Pin_Sens_Low_net;
	wire [0:0] tmpFB_0__Pin_Sens_Low_net;
	wire [0:0] tmpIO_0__Pin_Sens_Low_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Sens_Low_net;
	electrical [0:0] tmpSIOVREF__Pin_Sens_Low_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Sens_Low
		 (.oe(tmpOE__Pin_Sens_Low_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Sens_Low_net[0:0]}),
		  .analog({Net_427}),
		  .io({tmpIO_0__Pin_Sens_Low_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Sens_Low_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Sens_Low_net[0:0]}),
		  .annotation({Net_466}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Sens_Low_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- AMux AMux_High start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 AMux_High(
        .muxin({
            Net_437,
            Net_434
            }),
    ...
    defparam AMux_High.muxin_width = 2;
    defparam AMux_High.init_mux_sel = 2'h0;
    defparam AMux_High.one_active = 0;
    defparam AMux_High.connect_mode = 1;
    ...
    defparam AMux_Low.muxin_width = 2;
    defparam AMux_Low.init_mux_sel = 2'h0;
    defparam AMux_Low.one_active = 0;
    defparam AMux_Low.connect_mode = 1;
    
    // -- AMux AMux_Low end --

    cy_annotation_universal_v1_0 I_1 (
        .connect({
            Net_466,
            Net_213
        })
    );
    defparam I_1.comp_name = "ISource_v1_0";
    defparam I_1.port_names = "N, P";
    defparam I_1.width = 2;
	...
	wire [0:0] tmpOE__Pin_Sens_High_net;
	wire [0:0] tmpFB_0__Pin_Sens_High_net;
	wire [0:0] tmpIO_0__Pin_Sens_High_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Sens_High_net;
	electrical [0:0] tmpSIOVREF__Pin_Sens_High_net;

	cy_psoc3_pins_v1_10
		#(.id("6c77684d-0673-47f9-beb6-1cc8ea555a3e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Sens_High
		 (.oe(tmpOE__Pin_Sens_High_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Sens_High_net[0:0]}),
		  .analog({Net_437}),
		  .io({tmpIO_0__Pin_Sens_High_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Sens_High_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Sens_High_net[0:0]}),
		  .annotation({Net_467}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Sens_High_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    IDAC_P4_v1_10_3 IDAC (
        .Iout(Net_326));
	...
	wire [0:0] tmpOE__GPIO_VREF_net;
	wire [0:0] tmpFB_0__GPIO_VREF_net;
	wire [0:0] tmpIO_0__GPIO_VREF_net;
	wire [0:0] tmpINTERRUPT_0__GPIO_VREF_net;
	electrical [0:0] tmpSIOVREF__GPIO_VREF_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_VREF
		 (.oe(tmpOE__GPIO_VREF_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_VREF_net[0:0]}),
		  .io({tmpIO_0__GPIO_VREF_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_VREF_net),
		  .interrupt({tmpINTERRUPT_0__GPIO_VREF_net[0:0]}),
		  .annotation({Net_260}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GPIO_VREF_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIO_S0_net;
	wire [0:0] tmpFB_0__GPIO_S0_net;
	wire [0:0] tmpIO_0__GPIO_S0_net;
	wire [0:0] tmpINTERRUPT_0__GPIO_S0_net;
	electrical [0:0] tmpSIOVREF__GPIO_S0_net;

	cy_psoc3_pins_v1_10
		#(.id("58b5f698-4843-4159-ac67-82ead5a4fb06"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_S0
		 (.oe(tmpOE__GPIO_S0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_S0_net[0:0]}),
		  .io({tmpIO_0__GPIO_S0_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_S0_net),
		  .interrupt({tmpINTERRUPT_0__GPIO_S0_net[0:0]}),
		  .annotation({Net_254}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GPIO_S0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIO_S1_net;
	wire [0:0] tmpFB_0__GPIO_S1_net;
	wire [0:0] tmpIO_0__GPIO_S1_net;
	wire [0:0] tmpINTERRUPT_0__GPIO_S1_net;
	electrical [0:0] tmpSIOVREF__GPIO_S1_net;

	cy_psoc3_pins_v1_10
		#(.id("ed399748-b511-420d-84fa-42bd8f5f2cf2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_S1
		 (.oe(tmpOE__GPIO_S1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_S1_net[0:0]}),
		  .io({tmpIO_0__GPIO_S1_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_S1_net),
		  .interrupt({tmpINTERRUPT_0__GPIO_S1_net[0:0]}),
		  .annotation({Net_255}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GPIO_S1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIO_EN_net;
	wire [0:0] tmpFB_0__GPIO_EN_net;
	wire [0:0] tmpIO_0__GPIO_EN_net;
	wire [0:0] tmpINTERRUPT_0__GPIO_EN_net;
	electrical [0:0] tmpSIOVREF__GPIO_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("43babe25-09b5-4064-9334-616d2ff363a0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIO_EN
		 (.oe(tmpOE__GPIO_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIO_EN_net[0:0]}),
		  .io({tmpIO_0__GPIO_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIO_EN_net),
		  .interrupt({tmpINTERRUPT_0__GPIO_EN_net[0:0]}),
		  .annotation({Net_259}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__GPIO_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IDAC_IN_net;
	wire [0:0] tmpFB_0__IDAC_IN_net;
	wire [0:0] tmpIO_0__IDAC_IN_net;
	wire [0:0] tmpINTERRUPT_0__IDAC_IN_net;
	electrical [0:0] tmpSIOVREF__IDAC_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("9eacec01-31b3-4c6b-937f-0fcc7fc8f8b4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IDAC_IN
		 (.oe(tmpOE__IDAC_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IDAC_IN_net[0:0]}),
		  .analog({Net_326}),
		  .io({tmpIO_0__IDAC_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__IDAC_IN_net),
		  .interrupt({tmpINTERRUPT_0__IDAC_IN_net[0:0]}),
		  .annotation({Net_327}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__IDAC_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_TurnOn_Sink_net;
	wire [0:0] tmpIO_0__Pin_TurnOn_Sink_net;
	wire [0:0] tmpINTERRUPT_0__Pin_TurnOn_Sink_net;
	electrical [0:0] tmpSIOVREF__Pin_TurnOn_Sink_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_TurnOn_Sink
		 (.oe(tmpOE__Pin_TurnOn_Sink_net),
		  .y({1'b0}),
		  .fb({Net_471}),
		  .io({tmpIO_0__Pin_TurnOn_Sink_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_TurnOn_Sink_net),
		  .interrupt({tmpINTERRUPT_0__Pin_TurnOn_Sink_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_TurnOn_Sink_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_TurnOff_Sink_net;
	wire [0:0] tmpIO_0__Pin_TurnOff_Sink_net;
	wire [0:0] tmpINTERRUPT_0__Pin_TurnOff_Sink_net;
	electrical [0:0] tmpSIOVREF__Pin_TurnOff_Sink_net;

	cy_psoc3_pins_v1_10
		#(.id("c210f099-8428-4cfe-92a7-f387988955ad"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_TurnOff_Sink
		 (.oe(tmpOE__Pin_TurnOff_Sink_net),
		  .y({1'b0}),
		  .fb({Net_474}),
		  .io({tmpIO_0__Pin_TurnOff_Sink_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_TurnOff_Sink_net),
		  .interrupt({tmpINTERRUPT_0__Pin_TurnOff_Sink_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_TurnOff_Sink_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
