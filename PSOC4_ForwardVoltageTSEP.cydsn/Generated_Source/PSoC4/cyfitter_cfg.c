...
static void AnalogSetDefault(void)
{
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTBM_OA0_SW, 0x00044000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTBM_OA1_SW, 0x00084000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTBM_CTB_SW_HW_CTRL, 0x0000000Cu);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x02430000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x00C30000u);
...
*
*******************************************************************************/
void AMux_High_Set(uint8 channel)
{
	switch (channel) {
		case 1u:
...
*
*******************************************************************************/
void AMux_High_Unset(uint8 channel)
{
	switch (channel) {
		case 1u:
...
*
*******************************************************************************/
void AMux_Low_Set(uint8 channel)
{
	switch (channel) {
		case 1u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTBM_OA1_SW, (0x02u));
			break;
		default:
			break;
	}
...
*
*******************************************************************************/
void AMux_Low_Unset(uint8 channel)
{
	switch (channel) {
		case 1u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTBM_OA1_SW_CLEAR, (0x02u));
			break;
		default:
			break;
	}
