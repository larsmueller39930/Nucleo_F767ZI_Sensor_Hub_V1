...
#define SPIS_COMP_VERSION_MAJOR    (4)
#define SPIS_COMP_VERSION_MINOR    (0)
...
*/
#define SPIS_SCB_SW_RESET   SPIS_I2CFwBlockReset()
...
#define SPIS_DISABLE_AUTO_DATA \
                do{                        \
                    SPIS_I2C_CTRL_REG &= ((uint32) ~(SPIS_I2C_CTRL_M_READY_DATA_ACK      |  \
                                                                 SPIS_I2C_CTRL_M_NOT_READY_DATA_NACK |  \
                                                                 SPIS_I2C_CTRL_S_READY_DATA_ACK      |  \
                                                                 SPIS_I2C_CTRL_S_NOT_READY_DATA_NACK)); \
                }while(0)
...
#define SPIS_GET_UART_RX_CTRL_BREAK_WIDTH(width)    (((uint32) ((uint32) (width) - 1u) << \
                                                                    SPIS_UART_RX_CTRL_BREAK_WIDTH_POS) & \
                                                                    SPIS_UART_RX_CTRL_BREAK_WIDTH_MASK)
