...
#define SPIS_UART_MP_RX_ADDRESS         (0x2u)
#define SPIS_UART_MP_RX_ADDRESS_MASK    (0xFFu)

#define SPIS_UART_INTERRUPT_MODE        (0u)

#define SPIS_UART_INTR_RX_MASK          (0x0u)
#define SPIS_UART_INTR_TX_MASK          (0x0u)
...
#define SPIS_UART_RX_BREAK_WIDTH        (11u)
...
/* UART specific functions */
    ...
    /* UART TX direction APIs */
        ...
        *******************************************************************************/
        ...
        void SPIS_UartSendBreakBlocking(uint32 breakWidth);
...
***************************************/
    ...
    #define SPIS_UART_DEFAULT_UART_RX_CTRL \
                    (SPIS_GET_UART_RX_CTRL_MODE(SPIS_UART_STOP_BITS_NUM)                    | \
                     ...
                     SPIS_GET_UART_RX_CTRL_BREAK_WIDTH(SPIS_UART_RX_BREAK_WIDTH)            | \
