...
#define ADC_SAR_DEFAULT_VREF_SEL               (1u)
...
#define ADC_SAR_DEFAULT_VREF_MV_VALUE          (3300)
#define ADC_SAR_DEFAULT_BUFFER_GAIN            (0u)
#define ADC_SAR_DEFAULT_AVG_SAMPLES_NUM        (4u)
#define ADC_SAR_DEFAULT_AVG_SAMPLES_DIV        (4u < 4u) ? (int16)(0x100u >> (7u - 4u)) : (int16)(0x100u >> 4u)
#define ADC_SAR_DEFAULT_AVG_MODE               (0u)
#define ADC_SAR_MAX_RESOLUTION                 (12u)
#define ADC_SAR_DEFAULT_LOW_LIMIT              (0u)
#define ADC_SAR_DEFAULT_HIGH_LIMIT             (2050u)
...
#define ADC_SAR_SEQUENCED_CHANNELS_NUM         (1u)
#define ADC_SAR_DEFAULT_EN_CHANNELS            (1u)
#define ADC_SAR_NOMINAL_CLOCK_FREQ             (9000000)
#define ADC_SAR_INJ_CHANNEL_ENABLED            (1u)
...
#define ADC_SAR_CHANNELS_MODE                  (2u)
