...
extern void AMux_High_Set(uint8 channel);
extern void AMux_High_Unset(uint8 channel);
extern void AMux_Low_Set(uint8 channel);
extern void AMux_Low_Unset(uint8 channel);
